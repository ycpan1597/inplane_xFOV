...
% Type of registration error used see image_difference.m
type='d';
...
[x]= lsqnonlin(@(x)affine_registration_image(x,scale,I1s,I2s,type),[0 0 0 100 100],[],[],optimset('Display','iter','MaxIter',100, 'PlotFcns', 'optimplotresnorm')); 
